#PVAL should be a vector where your p-values are stored.
...
## add the qqplot
qqplot(null,PVAL, ylim=c(0,MAX),xlim=c(0,MAX), pch=19,main=list(paste("QQplot, ",allele," interaction term p-values (",cohort,"), ",mylink,sep=""),cex=1.3),
